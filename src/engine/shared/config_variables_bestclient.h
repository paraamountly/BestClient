...
MACRO_CONFIG_INT(BcSnapTapSmartStopMultitick, bc_snap_tap_smart_stop_multitick, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Use a three-tick local lookahead for Gores Smart Stop")
MACRO_CONFIG_INT(BcSnapTapSmartSwitch, bc_snap_tap_smart_switch, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable physics-aware Gores direction switching after releasing the opposite key")
MACRO_CONFIG_INT(BcSnapTapSmartSwitchWindow, bc_snap_tap_smart_switch_window, 120, 0, 250, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Gores Smart Direction Switch release window in milliseconds")
